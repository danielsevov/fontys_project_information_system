...
public final class PGDAOFactory extends DAOFactory {
    ...
    @Override
    public <E extends Entity, K extends Serializable> PGDAO<E, K> createDao(Class<E> forClass) {
        QueryFactory queryTextCache = queryStringCache.computeIfAbsent(forClass, x -> new QueryFactory(Mapper.mapperFor(forClass)));
        return new PGDAO<>(this, forClass, queryTextCache);
    }

    @Override
    public <E extends Entity, K extends Serializable> PGDAO<E, K> createDao(Class<E> forClass, TransactionToken token) {
    ...
    {
        registerInMarshaller(LocalDate.class, Date::toLocalDate);
        registerInMarshaller(LocalDateTime.class, Timestamp::toLocalDateTime);
    }
...
//    }
    ...
    <U> U marshallIn(Class<U> type, Object in) {
        return ((Function<Object, U>) marshallInMap.getOrDefault(type, x -> x)).apply(in);
    }
    ...
    <U> U marshallOut(Object out) {
        return ((Function<Object, U>) marshallOutMap.getOrDefault(out.getClass(), x -> x)).apply(out);
    }
